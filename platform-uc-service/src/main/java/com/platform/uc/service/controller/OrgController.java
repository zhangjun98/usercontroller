...
public class OrgController {
    ...
    @GetMapping("/findTree")
    @ResponseBody
    public BizResponse<List<Org>> findTree(String orgName){
        try {
    ...
    @ResponseBody
    public BizResponse<List<Org>> findAllOrg(){
        try {
    ...
    @PostMapping("/update")
    @ResponseBody
    public BizResponse<Integer> update(@RequestBody Org org){
        try {
    ...
    @GetMapping("/search")
    @ResponseBody
    public BizResponse<Org> search(@RequestParam Long id){
        try {
    ...
    @GetMapping("/delete")
    @ResponseBody
    public  BizResponse<Integer> delete(@RequestParam Long id){
        try {
